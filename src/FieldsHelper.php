...
class FieldsHelper
{
    ...
    public static function getFormFields( $fieldsArr )
    {
        $formFields = [];

        foreach ($fieldsArr as $field_name => $options){
            // if $options is a string then its a simple text field,
    ...
    public static function getValidationRules($fields, $item = null)
    {
        $rules = [];
        foreach ($fields as $field_name => $options){
