...
namespace Rashidul\Hailstorm\Hook;

class Events {

	/**
	 * Holds all registered actions
	 * @var Rashidul\Hailstorm\Hook\Action
	 */
	protected $action;

	/**
	 * Holds all registered filters
	 * @var Rashidul\Hailstorm\Hook\Filter
	 */
	protected $filter;
	 ...
	 * @return Rashidul\Hailstorm\Hook\Action
	 */
	...
	/**
	 * Get the action instance
	 * @return Rashidul\Hailstorm\Hook\Filter
	 */
